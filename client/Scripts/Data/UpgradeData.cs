...
public static class UpgradeData
{
    ...
    private static readonly float[] SpreadAngles = { 0f, 15f, 30f, 45f, 50f, 55f, 60f, 65f };
    public static float GetSpreadAngle(int level) => level >= 0 && level < SpreadAngles.Length ? SpreadAngles[level] : 65f;
    ...
    public const int   OrbitDamage         = 8;
    public const float OrbitHitInterval    = 0.5f;
}
